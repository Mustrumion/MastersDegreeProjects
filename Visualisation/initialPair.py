...
seriesFolders = ['solutions/experiment_initial_old', 'solutions/base_popualtion_ls_compat_oneforall']
seriesNames = ['Improving Inserts Heuristic', 'Random Compatible + Compound + Local Search']
