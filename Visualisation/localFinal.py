...
mainDimensions = ['Time [s]','Average loss']
adjustToSize = False
fieldNames = ['Moves performed', 'Time [s]', 'Average acceptability function value', 'Average loss', 'Acceptable', 'Action']

seriesFolders = ['solutions/base_popualtion_ls_compat_oneforall', 'solutions/base_popualtion_ls_random_oneforall']
seriesNames = ['Random Compatible + Compound + Local', 'Random Bulk + Compound + Local']
